...
def main(msg, itos_blob: func.InputStream, enc_weight_blob: func.InputStream, weight_blob: func.InputStream) -> None:
    ...
    tempdir = mkdtemp()
    export_path = None
    itos_file, weight_file, enc_weight_file = download_model(tempdir, itos_blob, weight_blob, enc_weight_blob)
    try:
